const ColorPalette = () => {
  return (
    ...
    <div className="h-8 bg-[#286DA8]" >Summer Sky</div> */}
      <div className="h-8 border bg-[#0B3C5d]">Prussian Blue #0B3C5d</div>
      <div className="h-8 border bg-[#CD5360]">Warm Peach #CD5360</div>
      <div className="h-8 border bg-[#B37D4E]">Field #B37D4E</div>
      <div className="h-8 border bg-[#438496]">Breeze #438496</div>
