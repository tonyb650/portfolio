...
const ColorPalette = () => {
  return (
    ...
    <div className="h-8 bg-[#286DA8]" >Summer Sky</div> */}
      <div className="h-8 bg-[#0B3C5d] border">Prussian Blue #0B3C5d</div>
      <div className="h-8 bg-[#CD5360] border">Warm Peach #CD5360</div>
      <div className="h-8 bg-[#B37D4E] border">Field #B37D4E</div>
      <div className="h-8 bg-[#438496] border">Breeze #438496</div>
    ...
    <div className="bg-[#1D2731] text-gray-200"></div>
